...
(function () {
  var TH = {
    ...
    "Symptoms you want to discuss":"อาการที่ต้องการปรึกษา","Describe your symptoms and general health information on one page to help the doctor assess you accurately.":"กรอกรายละเอียดอาการและข้อมูลสุขภาพทั่วไปในหน้าเดียว เพื่อช่วยให้แพทย์ประเมินได้แม่นยำขึ้น","What are your symptoms?":"อาการเป็นอย่างไรบ้าง?","For example: an itchy, swollen or red rash, or pain":"เช่น ผื่นคันที่แขน บวม แดง หรือมีอาการปวด","How long have you had these symptoms?":"เป็นมานานแค่ไหนแล้ว?","What have you already tried to relieve the symptoms?":"ทำอะไรเพื่อบรรเทาอาการไปแล้วบ้าง?","Nothing yet":"ยังไม่ได้ทำ","Used medicine":"ทานหรือใช้ยา","Saw a doctor":"พบแพทย์","Do you have photos of the symptoms or medicine?":"มีรูปประกอบอาการหรือยาหรือไม่?","Up to 5 photos · 10 MB each":"สูงสุด 5 รูป · 10 MB ต่อรูป","The same health record is used for both Krane and insurance entry.":"ใช้ข้อมูลชุดเดียวกันทั้งการเข้าทาง Krane และสิทธิ์ประกัน","Confirm information and continue":"ยืนยันข้อมูลและดำเนินการต่อ",
