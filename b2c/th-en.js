...
(function () {
  var EN = {
    ...
    "พื้นที่สำหรับผลลัพธ์จริง":"Space for real outcomes",
    ...
    "*Placeholder สำหรับภาพที่ได้รับอนุญาตและได้รับความยินยอมแล้วเท่านั้น":"*Placeholder for authorised images with patient consent only",
