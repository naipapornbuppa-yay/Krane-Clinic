(() => {
  const translations = {
    en: {
      ...
      differenceDoctorTitle: "Thai doctors who know your care",
      differenceDoctorBody: "Licensed doctors provide continuity without starting over each time.",
      ...
      differenceDeliveryTitle: "Discreet delivery across Thailand",
