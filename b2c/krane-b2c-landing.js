(() => {
  const translations = {
    en: {
      announcementCampaign: "Special: free doctor consultation through January 1, 2027",
      announcementLink: "Start now",
      ...
      heroTitle: "Health you can<br>feel confident in",
      bannerWeightTitle: "Lose weight safely<br>with GLP-1s",
      bannerWeightProducts: "Oral options available · New · Great value",
      bannerWeightCta: "Start now",
      bannerEdTitle: "More confidence<br>in men's health (ED)",
      ...
      heroLegal: "Nationwide delivery · Private 1-to-1 doctor consultation · Licensed doctors · Start 100% online · FDA-approved medicine · Personalised treatment plans · Discreet packaging",
      ...
      protocolLead: "Product assurance and delivery through the Fascino pharmacy network.",
      benefit1Title: "Clinic licence no. 10101017669",
      benefit1Body: "Every consultation is led by a certified doctor dedicated to your health.",
      benefit2Title: "Telemedicine services",
      benefit2Body: "Your health records and conversations are securely encrypted and protected.",
      benefit3Title: "Authentic medicine, delivered home",
      benefit3Body: "Delivered to your door in unbranded packaging with nothing to indicate what is inside.",
      benefit4Title: "Product assurance and delivery through the Fascino pharmacy network",
      ...
      guaranteeTitle: "We care about<br>your privacy",
      guaranteeLead: "Protected under PDPA · View, correct or delete your information at any time · Visible only to your care doctor · Your treatment information stays confidential · Pharmacies see only the items needed for delivery · Never shared with third parties",
      privacyNote: "We will not disclose your information to third parties without your consent unless required by law.",
      standardsLine: "International security standards powered by INET · ISO/IEC 27001:2022 · ISO/IEC 27018 · CSA STAR",
  ...
  function setLanguage(language) {
    ...
    document.querySelector(".announcement")?.setAttribute(
      "aria-label",
      lang === "th" ? "พิเศษ! ปรึกษาแพทย์ฟรี ไม่มีค่าใช้จ่าย ถึง 1 มกราคม 2027" : "Special: free doctor consultation through January 1, 2027"
    );
