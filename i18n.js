/* ============================================================
   ...
   Wires itself to either the app [data-lang] buttons or the shared
   landing-style select[data-language].
   ============================================================ */
(function () {
  var TH = {
    /* ---- common / buttons ---- */
    "Continue":"ดำเนินการต่อ","Next":"ถัดไป","Start":"เริ่มต้น","Skip":"ข้าม","Back":"ย้อนกลับ","Send":"ส่ง","Pay":"ชำระ","securely":"อย่างปลอดภัย","Apply":"ใช้","Edit":"แก้ไข","log in":"เข้าสู่ระบบ","Log in":"เข้าสู่ระบบ",
    ...
    "Private care, wherever you are.":"ดูแลสุขภาพอย่างเป็นส่วนตัวได้ทุกที่","Consult a licensed doctor from your phone, without travelling to a clinic.":"ปรึกษาแพทย์ที่มีใบอนุญาตผ่านโทรศัพท์ โดยไม่ต้องเดินทางไปคลินิก",
    "Care built around you.":"แผนการดูแลที่ออกแบบเพื่อคุณ","Your doctor reviews your health and recommends a plan that fits your needs.":"แพทย์จะประเมินข้อมูลสุขภาพและแนะนำแผนที่เหมาะกับคุณ",
    "From consultation to your door.":"ตั้งแต่การปรึกษาจนถึงหน้าประตูบ้าน","If prescribed, receive your treatment discreetly and continue your care at home.":"หากแพทย์สั่งการรักษา คุณจะได้รับอย่างเป็นส่วนตัวและดูแลต่อเนื่องได้ที่บ้าน",
    /* ---- concern / category ---- */
    "What kind of care do you need?":"คุณต้องการการดูแลแบบไหน?","Choose the option closest to your concern. Not sure? Select General consultation.":"เลือกหมวดที่ใกล้เคียงกับอาการของคุณที่สุด หากไม่แน่ใจ ให้เลือกปรึกษาทั่วไป",
    ...
    "Review your answers":"ตรวจทานคำตอบ","Make sure this looks right before a doctor reviews it.":"ตรวจให้แน่ใจก่อนที่แพทย์จะตรวจสอบ",
    ...
    "1-6 months":"1-6 เดือน","Tell us more about this concern":"เล่าอาการนี้ให้เรารู้เพิ่มอีกนิด","Choose the answers that best describe what you're experiencing.":"เลือกคำตอบที่ตรงกับอาการของคุณมากที่สุด",
    ...
    "Do any urgent warning signs apply today?":"วันนี้คุณมีสัญญาณอันตรายเร่งด่วนเหล่านี้หรือไม่?","Select any that apply. For severe symptoms or immediate danger, call emergency services or go to the nearest emergency department now.":"เลือกทุกข้อที่ตรงกับคุณ หากมีอาการรุนแรงหรือรู้สึกว่าอาจเป็นอันตรายทันที ให้โทรเรียกบริการฉุกเฉินหรือไปห้องฉุกเฉินที่ใกล้ที่สุดทันที",
    ...
    /* ---- account ---- */
    "Before your assessment":"ก่อนเริ่มแบบประเมิน","Keep your health information with the right person":"เก็บข้อมูลสุขภาพไว้กับบัญชีที่ถูกต้อง","Create an account or log in before answering health questions. This keeps your assessment, doctor messages and prescriptions together securely.":"สร้างบัญชีหรือเข้าสู่ระบบก่อนตอบคำถามสุขภาพ เพื่อเก็บแบบประเมิน ข้อความจากแพทย์ และใบสั่งยาไว้ด้วยกันอย่างปลอดภัย","Secure health record":"เวชระเบียนที่ปลอดภัย","Your answers are saved to your account, not this device.":"คำตอบจะบันทึกไว้ในบัญชี ไม่ได้เก็บไว้เฉพาะอุปกรณ์นี้","Continue without starting over":"กลับมาทำต่อได้โดยไม่ต้องเริ่มใหม่","Return to your assessment and care plan at any time.":"กลับมาดูแบบประเมินและแผนการดูแลได้ทุกเมื่อ","I already have an account":"ฉันมีบัญชีแล้ว","Create your account":"สร้างบัญชีของคุณ","Create your secure care account":"สร้างบัญชีสุขภาพที่ปลอดภัย","Your account keeps your assessment, doctor messages, prescriptions and delivery updates in one private place.":"บัญชีของคุณเก็บแบบประเมิน ข้อความจากแพทย์ ใบสั่งยา และสถานะจัดส่งไว้ในที่เดียวอย่างเป็นส่วนตัว","Create account & continue":"สร้างบัญชีและไปต่อ","Continue with LINE":"ดำเนินการต่อด้วย LINE","Continue with Google":"ดำเนินการต่อด้วย Google","Full name":"ชื่อ-นามสกุล","Phone number":"เบอร์โทรศัพท์","Welcome back":"ยินดีต้อนรับกลับ","You'll review service, privacy and telemedicine consent on the next step.":"ขั้นตอนถัดไปจะแสดงข้อตกลงบริการ ความเป็นส่วนตัว และการแพทย์ทางไกลให้ตรวจสอบ","New here? Create an account":"ยังไม่มีบัญชี? สร้างบัญชี",
    /* ---- booking / matching ---- */
    ...
    "Waiting room":"ห้องรอ","Waiting for Dr. Narin to let you in":"กำลังรอ Dr. Narin เรียกเข้าห้อง","Enter the room":"เข้าห้องปรึกษา","Notify me when it's ready":"แจ้งเตือนเมื่อพร้อม",
    ...
    "Dr. Narin joins the room first. You'll be admitted the moment they're ready. Please keep this screen open.":"Dr. Narin จะเข้าห้องก่อน คุณจะได้รับเข้าทันทีที่แพทย์พร้อม กรุณาเปิดหน้าจอนี้ค้างไว้",
    ...
    "Less than 1 month":"น้อยกว่า 1 เดือน","Dr. Narin · ready now":"Dr. Narin · พร้อมแล้ว","Minoxidil: what to expect":"ไมน็อกซิดิล: สิ่งที่ควรคาดหวัง","Factors like":"ปัจจัยอย่าง","aging":"อายุที่มากขึ้น","family history":"ประวัติครอบครัว","stress":"ความเครียด","and":"และ",
    ...
    "Waiting to be admitted…":"รอแพทย์เปิดห้องให้เข้า…","Doctor is ready":"แพทย์พร้อมแล้ว","Dr. Narin is ready for you now":"Dr. Narin พร้อมพบคุณแล้ว",
    ...
    "Your clinical step with Dr. Narin is complete. A licensed pharmacist now takes over medicine preparation, payment and delivery.":"ขั้นตอนทางคลินิกกับ Dr. Narin เสร็จสิ้นแล้ว เภสัชกรที่มีใบอนุญาตจะดูแลการจัดยา การชำระเงิน และการจัดส่งต่อจากนี้",
    ...
    "Share fresh photos of the area and tell Dr. Narin how the treatment feels so far.":"ส่งรูปถ่ายล่าสุดของบริเวณที่รักษา และเล่าให้ Dr. Narin ฟังว่าการรักษาเป็นอย่างไรบ้าง",
    ...
    "Next follow-up":"นัดติดตามครั้งถัดไป","12 Sep 2026 · Dr. Narin":"12 ก.ย. 2026 · Dr. Narin","Start follow-up":"เริ่มติดตามผล",
    ...
    "Already have a prescription? Upload it for pharmacy review":"มีใบสั่งยาแล้ว? อัปโหลดให้ร้านยาตรวจสอบ",
    ...
    "Message Dr. Narin now":"ทัก Dr. Narin ตอนนี้",
    ...
    "Preparing your plan":"กำลังเตรียมแผนของคุณ","Dr. Narin is writing your prescription":"Dr. Narin กำลังเขียนใบสั่งยาของคุณ",
  ...
  var TH_CMS = {
    ...
    "‹ Mali S. · pre-consult":"‹ Mali S. · ก่อนปรึกษา",
    "Consultation · Mali S.":"การปรึกษา · Mali S.",
    ...
    "Prescribe treatment · Mali S.":"สั่งการรักษา · Mali S.",
  ...
  var TH_CLIENT14 = {
    ...
    "Mali S. · intake submitted":"Mali S. · ส่งแบบสอบถามแล้ว","Mali S. · intake complete":"Mali S. · แบบสอบถามครบ","Plans to finish":"แผนที่ต้องทำให้เสร็จ","After visit":"หลังพบผู้ป่วย","Win T. · prescription pending":"Win T. · รอจัดใบสั่งยา",
    ...
    "Previous period":"ช่วงก่อนหน้า","Next period":"ช่วงถัดไป","June 2026":"มิถุนายน 2569","Tuesday, 24 June 2026":"วันอังคารที่ 24 มิถุนายน 2569","09:00 to 18:00":"09:00 ถึง 18:00","Month":"เดือน","Day":"วัน","Calendar view":"มุมมองปฏิทิน","case":"เคส","cases":"เคส","more":"เพิ่มเติม",
    ...
    "Confirm your account":"ยืนยันบัญชีของคุณ","You’re signed in":"เข้าสู่ระบบแล้ว","Check the details shared by":"ตรวจสอบข้อมูลที่ได้รับจาก","before continuing.":"ก่อนดำเนินการต่อ","Verified":"ยืนยันแล้ว","First name":"ชื่อ","Last name":"นามสกุล","Confirm & continue":"ยืนยันและไปต่อ","Use another account":"ใช้บัญชีอื่น",
  ...
  var TH_B2C_QA15 = {
    ...
    "We sent a 6-digit code to your phone and email. Enter it to confirm it's you.":"เราส่งรหัส 6 หลักไปยังโทรศัพท์และอีเมล โปรดกรอกเพื่อยืนยันตัวตน","Didn't get it?":"ยังไม่ได้รับรหัส?","Resend code":"ส่งรหัสอีกครั้ง","· sent via SMS & email":"· ส่งผ่าน SMS และอีเมล",
  ...
  function swap(th) {
    ...
    nodes.forEach(function (node) {
      if (th) {
        ...
        if (TH[key] !== undefined) { if (node.__en === undefined) node.__en = node.nodeValue; node.nodeValue = node.nodeValue.replace(key, TH[key]); }
  ...
  function setToggles(th) {
    ...
    [].forEach.call(document.querySelectorAll("select[data-language]"), function (x) {
      x.value = th ? "th" : "en";
    });
  }
  ...
  document.addEventListener("change", function (e) {
    var select = e.target.closest && e.target.closest("select[data-language]");
    if (!select) return;
    var th = select.value !== "en";
    apply(th); persist(th); broadcast(th);
  });
