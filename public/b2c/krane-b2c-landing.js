(() => {
  const translations = {
    en: {
      ...
      announcementOnline: "Start instantly, 100% online",
      announcementFda: "Thai FDA-approved medicine",
      announcementPlan: "Personalised treatment plans",
      announcementDiscreet: "Discreet packaging",
      ...
      privacyPdpaTitle: "Protected under PDPA",
      privacyPdpaBody: "Request to view, correct or delete your data at any time.",
      privacyDoctorTitle: "Visible only to your care team",
      privacyDoctorBody: "Treatment information remains confidential. The pharmacy only sees medicine details needed for delivery.",
      privacyShareTitle: "Never shared without consent",
  ...
  const draftEnglishText = new Map([
    ...
    ["ซิลเดนาฟิล", "Sildenafil"], ["แพทย์พิจารณาขนาดยาและความเหมาะสมเป็นรายบุคคล", "A doctor considers the dose and suitability for you"],
    ["ทาดาลาฟิล", "Tadalafil"],
    ["แพทย์พิจารณาจากประวัติสุขภาพและยาที่ใช้อยู่", "A doctor considers your health history and current medicines"],
    ["วาร์เดนาฟิล", "Vardenafil"], ["อีกหนึ่งทางเลือกที่แพทย์อาจพิจารณาตามสุขภาพ", "Another option a doctor may consider based on your health"],
    ["อะวานาฟิล", "Avanafil"], ["แพทย์ประเมินร่วมกับโรคประจำตัวและยาที่ใช้อยู่", "A doctor assesses your medical conditions and current medicines"],
