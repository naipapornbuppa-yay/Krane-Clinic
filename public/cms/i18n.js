...
(function () {
  ...
  var TH_ADMIN15 = {
    ...
    "Confirm refund":"ยืนยันการคืนเงิน","Return the captured payment to the patient and stop fulfilment for this order.":"คืนยอดที่ชำระให้ผู้ป่วยและหยุดการจัดส่งของออเดอร์นี้","No payment captured":"ยังไม่มีการตัดเงิน","Refunded":"คืนเงินแล้ว","Just now":"เมื่อสักครู่","Refund initiated":"เริ่มดำเนินการคืนเงินแล้ว","Golden demo":"เดโมหลัก","Open golden order":"เปิดออเดอร์เดโม","Mali S. (Demo)":"มะลิ เอส. (เดโม)","Fascino Ari":"ฟาสซิโน อารีย์",
