...
(function () {
  ...
  /* ---- doctor core flow, from the Doctor Manual (Krane Drive) · 18 Sep ---- */
  var TH_DOCTOR_CORE = {
    "Main":"หลัก",
    "Dispensed medicine":"รายการยาที่จ่าย",
    "‹ Back to consultation patients":"‹ กลับไปรายชื่อผู้เข้ารับการปรึกษา",
    "Consultation patients":"ผู้เข้ารับการปรึกษา",
    "Consultation patients · open a patient":"ผู้เข้ารับการปรึกษา · เปิดผู้ป่วย",
    "Home":"หน้าหลัก",
    "Consultations":"การปรึกษา",
    "Doctors":"แพทย์",
    "Examination schedule":"ตารางตรวจ",
    "Available":"ว่าง",
    "Occupied":"ไม่ว่าง",
    "My profile":"โปรไฟล์ของฉัน",
    "Log out":"ออกจากระบบ",
    "Licence no. 12345":"เลขที่ใบอนุญาต 12345",
    "Service status":"สถานะการให้บริการ",
    "You are Occupied. Krane will not match new patients to you until you switch back to Available.":"คุณอยู่ในสถานะไม่ว่าง ระบบจะไม่ส่งผู้ป่วยใหม่ให้จนกว่าคุณจะเปลี่ยนกลับเป็นว่าง",
    "Doctor sign in":"เข้าสู่ระบบสำหรับแพทย์",
    "Choose how to sign in. Every time, we send a one-time code to your registered mobile.":"เลือกวิธีเข้าสู่ระบบ ทุกครั้งระบบจะส่งรหัส OTP ไปยังเบอร์มือถือที่ลงทะเบียนไว้",
    "Phone number":"เบอร์โทรศัพท์",
    "LINE":"LINE",
    "Email":"อีเมล",
    "Mobile number":"เบอร์มือถือ",
    "Password":"รหัสผ่าน",
    "You continue in LINE and come back here for the code.":"ระบบจะพาไปยืนยันใน LINE แล้วกลับมากรอกรหัสที่หน้านี้",
    "Request OTP":"ขอรหัส OTP",
    "Continue with LINE":"ดำเนินการต่อด้วย LINE",
    "No account yet? Contact a Krane admin to create one for you.":"ยังไม่มีบัญชี? ติดต่อแอดมิน Krane เพื่อสร้างบัญชีให้คุณ",
    "Enter the OTP":"กรอกรหัส OTP",
    "We sent a 6-digit code to 08x-xxx-5678. It expires in 5 minutes.":"เราส่งรหัส 6 หลักไปที่ 08x-xxx-5678 รหัสจะหมดอายุใน 5 นาที",
    "One-time code":"รหัสยืนยัน",
    "Enter all 6 digits of the code.":"กรอกรหัสให้ครบ 6 หลัก",
    "Verify and sign in":"ยืนยันและเข้าสู่ระบบ",
    "Use another method":"เปลี่ยนวิธีเข้าสู่ระบบ",
    "Resend code":"ส่งรหัสอีกครั้ง",
    "Everyone booked for a consultation. Open a patient to review their record and join the call.":"ผู้ป่วยทุกคนที่จองการปรึกษา เปิดรายชื่อเพื่อดูข้อมูลและเข้าห้องปรึกษา",
    "Refresh":"รีเฟรช",
    "List refreshed":"รีเฟรชรายการแล้ว",
    "Patient name":"ชื่อผู้ป่วย",
    "Search by patient name":"ค้นหาด้วยชื่อผู้ป่วย",
    "Doctor":"แพทย์",
    "All doctors":"แพทย์ทั้งหมด",
    "Dr. Narin Tanaka":"คุณหมอนรินทร์ ทานากะ",
    "Dr. Anong":"คุณหมออนงค์",
    "Dr. Pakorn":"คุณหมอปกรณ์",
    "Dr. Sirin":"คุณหมอศิรินทร์",
    "Consult code":"รหัสการปรึกษา",
    "For example CONS-2041":"เช่น CONS-2041",
    "Consultation status":"สถานะการปรึกษา",
    "All statuses":"ทุกสถานะ",
    "Filling in form":"กรอกแบบฟอร์ม",
    "Waiting in queue":"รอคิวปรึกษา",
    "Call back":"ให้ติดต่อกลับ",
    "In consultation":"กำลังปรึกษา",
    "Paused":"พักการปรึกษา",
    "Cancelled":"ยกเลิกเสร็จสิ้น",
    "Consult again":"ให้คำปรึกษาใหม่",
    "Date / time":"วัน / เวลา",
    "Status":"สถานะ",
    "Patient":"ผู้ป่วย",
    ...
    "No consultations match this search.":"ไม่พบการปรึกษาที่ตรงกับการค้นหา",
    "24 Jun 2026":"24 มิ.ย. 2026",
    "23 Jun 2026":"23 มิ.ย. 2026",
    "22 Jun 2026":"22 มิ.ย. 2026",
    "Krane doctors and their service status right now. Open your own name to edit your details.":"แพทย์ของ Krane และสถานะการให้บริการตอนนี้ คลิกที่ชื่อของคุณเพื่อแก้ไขข้อมูล",
    "Search by doctor name":"ค้นหาด้วยชื่อแพทย์",
    "Offline":"ออฟไลน์",
    "Consultations today":"การปรึกษาวันนี้",
    "You · licence no. 12345":"คุณ · เลขที่ใบอนุญาต 12345",
    "Licence no. 20871":"เลขที่ใบอนุญาต 20871",
    "Licence no. 31442":"เลขที่ใบอนุญาต 31442",
    "Licence no. 28650":"เลขที่ใบอนุญาต 28650",
    "Dermatology · Hair and scalp":"ผิวหนัง · เส้นผมและหนังศีรษะ",
    "General practice":"เวชปฏิบัติทั่วไป",
    "Internal medicine":"อายุรกรรม",
    "Dermatology":"ผิวหนัง",
    "Edit my details":"แก้ไขข้อมูลของฉัน",
    "Only an admin can edit another doctor's details":"เฉพาะแอดมินที่แก้ไขข้อมูลของแพทย์ท่านอื่นได้",
    "No doctors match this search.":"ไม่พบแพทย์ที่ตรงกับการค้นหา",
    "Patient information":"ข้อมูลผู้ป่วย",
    "Edit":"แก้ไข",
    "Symptoms":"อาการ",
    "Hair thinning or shedding at the crown":"ผมบางหรือร่วงบริเวณกลางศีรษะ",
    "Drug allergies":"แพ้ยา",
    "None declared":"ไม่มีการแจ้ง",
    "Chronic conditions":"โรคประจำตัว",
    "Current medication":"ยาที่ใช้อยู่",
    "Treatment history":"ประวัติการรักษา",
    "Finasteride and minoxidil since May 2026":"Finasteride และ minoxidil ตั้งแต่ พ.ค. 2026",
    "Change log":"ประวัติการแก้ไข",
    "set to \"None reported\"":"เปลี่ยนเป็น \"ไม่มีโรคประจำตัว\"",
    "Dr. Anong · 8 May 2026 · 09:12":"คุณหมออนงค์ · 8 พ.ค. 2026 · 09:12",
    "Patient record":"ข้อมูลผู้ป่วย",
    "Consultation":"การปรึกษา",
    "Link":"ลิงก์",
    "Chat":"แชท",
    "Booked for":"เวลานัด",
    "24 Jun 2026 · 11:00":"24 มิ.ย. 2026 · 11:00",
    "Consultation length":"ระยะเวลาการปรึกษา",
    "Not started":"ยังไม่เริ่ม",
    "Consultation fee":"ค่าปรึกษา",
    "฿ 350 · paid":"฿ 350 · ชำระแล้ว",
    "Links sent to the patient to join a consultation.":"ประวัติการส่งลิงก์ให้ผู้ป่วยเข้ามาปรึกษาแพทย์",
    "Send link":"ส่งลิงก์",
    "Sent":"ส่งเมื่อ",
    "Channel":"ช่องทาง",
    "Sent by":"ผู้ส่ง",
    "System":"ระบบ",
    "Opened":"เปิดแล้ว",
    "24 Jun 2026 · 10:58":"24 มิ.ย. 2026 · 10:58",
    "Calls made back to the patient.":"ประวัติการโทรติดต่อกลับไปหาผู้ป่วย",
    "Add callback":"เพิ่มการติดต่อกลับ",
    "Date":"วันที่",
    "By":"โดย",
    "Note":"หมายเหตุ",
    "8 May 2026 · 15:40":"8 พ.ค. 2026 · 15:40",
    "Called to explain how to apply minoxidil. Patient understood.":"โทรอธิบายวิธีทา minoxidil ผู้ป่วยเข้าใจแล้ว",
    "Good morning doctor. I sent a new photo of my crown.":"สวัสดีครับคุณหมอ ผมส่งรูปกลางศีรษะใหม่ไปแล้วครับ",
    "Is it okay to keep using the shampoo from last time?":"แชมพูที่ใช้ครั้งก่อนใช้ต่อได้ไหมครับ",
    "Message the patient":"ส่งข้อความถึงผู้ป่วย",
    "Finish consultation":"เสร็จสิ้นการปรึกษา",
    "Call the patient again":"โทรหาผู้ป่วยอีกครั้ง",
    "Clinical notes (SOAP)":"บันทึกการตรวจ (SOAP)",
    "not shown to the patient":"ผู้ป่วยไม่เห็น",
    "S · Subjective":"S · อาการที่ผู้ป่วยเล่า",
    "O · Objective":"O · สิ่งที่ตรวจพบ",
    "A · Assessment":"A · การวินิจฉัย",
    "P · Plan":"P · แนวทางการรักษา",
    "Saved automatically":"บันทึกอัตโนมัติแล้ว",
    "Saving":"กำลังบันทึก",
    "Recommended medicine (draft)":"รายการยา (ร่าง)",
    "Finasteride 1mg":"Finasteride 1mg",
    "1 tablet once daily":"รับประทานครั้งละ 1 เม็ด วันละ 1 ครั้ง",
    "Apply 1 mL to the scalp twice daily":"ทา 1 มล. ที่หนังศีรษะ วันละ 2 ครั้ง",
    "Show the prescription in chat":"แสดงใบสั่งยาในแชท",
    "The patient sees the list in chat. It is not an order until you create one after the call.":"ผู้ป่วยเห็นรายการยาในแชท ยังไม่ใช่การสร้างออเดอร์จนกว่าคุณจะสร้างหลังจบการปรึกษา",
    "Finish this consultation?":"เสร็จสิ้นการปรึกษานี้?",
    "Does this consultation include medicine?":"การปรึกษาครั้งนี้มีการจ่ายยาหรือไม่",
    "Medicine dispensed":"มีการจ่ายยา",
    "Write the prescription and create an order next.":"ออกใบสั่งยาและสร้างคำสั่งซื้อในขั้นถัดไป",
    "No medicine":"ไม่มีการจ่ายยา",
    "Close the consultation with your notes only.":"ปิดการปรึกษาโดยบันทึกเฉพาะผลการตรวจ",
    "Remote care is not appropriate":"ไม่เหมาะกับการดูแลทางไกล",
    "Close without prescribing and send urgent or in-person care guidance.":"ปิดเคสโดยไม่สั่งยา และส่งคำแนะนำให้รับบริการเร่งด่วนหรือพบแพทย์ที่สถานพยาบาล",
    "Referral and escalation":"การส่งต่อและยกระดับการดูแล",
    "Document why remote care is not appropriate and give the patient a safe next step.":"บันทึกเหตุผลที่การดูแลทางไกลไม่เหมาะสมและกำหนดขั้นตอนถัดไปที่ปลอดภัยให้ผู้ป่วย",
    "No prescription":"ไม่มีใบสั่งยา",
    "Clinical decision":"การตัดสินใจทางคลินิก",
    "Patient identity and telemedicine consent verified before escalation.":"ยืนยันตัวตนผู้ป่วยและความยินยอมรับบริการการแพทย์ทางไกลแล้วก่อนส่งต่อ",
    "Reason remote care is not appropriate":"เหตุผลที่การดูแลทางไกลไม่เหมาะสม",
    "Warning signs require physical examination":"สัญญาณเตือนจำเป็นต้องตรวจร่างกาย",
    "Emergency symptoms":"อาการฉุกเฉิน",
    "Diagnosis cannot be confirmed remotely":"ไม่สามารถยืนยันการวินิจฉัยจากระยะไกล",
    "Procedure or diagnostic test is required":"จำเป็นต้องทำหัตถการหรือการตรวจวินิจฉัย",
    "Other clinical reason":"เหตุผลทางคลินิกอื่น",
    "Urgency":"ระดับความเร่งด่วน",
    "Urgent - seek care now":"เร่งด่วน - รับบริการทันที",
    "Same day in-person assessment":"ตรวจที่สถานพยาบาลภายในวันนี้",
    "Routine in-person appointment":"นัดตรวจที่สถานพยาบาลตามปกติ",
    "Clinical handoff note":"บันทึกส่งต่อทางคลินิก",
    "Destination and patient instructions":"ปลายทางและคำแนะนำสำหรับผู้ป่วย",
    "Destination":"สถานที่ส่งต่อ",
    "Contact / service point":"ช่องทางติดต่อ / จุดบริการ",
    "Instructions sent to patient":"คำแนะนำที่ส่งให้ผู้ป่วย",
    "Patient understands the next step":"ผู้ป่วยเข้าใจขั้นตอนถัดไป",
    "Record verbal acknowledgement or message delivery before closing the case.":"บันทึกการยืนยันด้วยวาจาหรือการส่งข้อความก่อนปิดเคส",
    "Referral has not been saved yet.":"ยังไม่ได้บันทึกการส่งต่อ",
    "Save referral and close consultation":"บันทึกการส่งต่อและปิดการปรึกษา",
    "Back to the call":"กลับไปที่การปรึกษา",
    "Confirm":"ยืนยัน",
    "‹ Back to consultation":"‹ กลับไปการปรึกษา",
    "Consult code CONS-2041 · the order is created only when you confirm it":"รหัสการปรึกษา CONS-2041 · ระบบสร้างคำสั่งซื้อเมื่อคุณยืนยันเท่านั้น",
    "From the consultation. Add an item to the dispensed list or leave it out.":"จากการปรึกษา เพิ่มลงรายการยาที่จ่ายหรือไม่ใส่ก็ได้",
    "Only medicine from the Krane list can be dispensed.":"จ่ายได้เฉพาะยาที่อยู่ในรายการของ Krane",
    "Search medicine":"ค้นหารายการยา",
    "Medicine":"รายการยา",
    "Qty":"จำนวน",
    "Directions":"วิธีใช้",
    "Price":"ราคา",
    "No medicine yet. Add from the draft or search the medicine list.":"ยังไม่มีรายการยา เพิ่มจากร่างหรือค้นหาจากรายการยา",
    "Items":"จำนวนรายการ",
    "Total medicine":"ยอดค่ายารวม",
    "Verified signer · Dr. Narin Tanaka · medical licence 12345":"ผู้ลงนามที่ตรวจสอบแล้ว · คุณหมอนรินทร์ ทานากะ · ใบอนุญาต 12345",
    "Dr. Narin Tanaka · licence 12345":"คุณหมอนรินทร์ ทานากะ · ใบอนุญาต 12345",
    "Save the prescription before you create the order.":"บันทึกใบสั่งยาก่อนสร้างคำสั่งซื้อ",
    "Save":"บันทึก",
    "Create order":"สร้าง Order",
    "Cancel":"ยกเลิก",
    "Search by":"ค้นหาจาก",
    "Brand":"ยี่ห้อสินค้า",
    ...
    "Create this order?":"ยืนยันการออกใบสั่งยา?",
    "The prescription is saved to the system and this consultation is marked complete. The patient then reviews the price and pays.":"ระบบจะบันทึกใบสั่งยาและถือว่าการปรึกษาเสร็จสิ้น จากนั้นผู้ป่วยตรวจราคาและชำระเงิน",
    "No":"ไม่",
    "Yes, create order":"ใช่ สร้าง Order",
    "Consultation complete":"การปรึกษาเสร็จสิ้น",
    "The prescription is saved and the order is created. The patient reviews the price and pays in the app.":"บันทึกใบสั่งยาและสร้างคำสั่งซื้อแล้ว ผู้ป่วยตรวจราคาและชำระเงินในแอป",
    "Your notes are saved. No medicine was dispensed in this consultation.":"บันทึกผลการตรวจแล้ว การปรึกษาครั้งนี้ไม่มีการจ่ายยา",
    "Your notes and remote-care decision are saved. Urgent or in-person care guidance was sent to the patient.":"บันทึกผลการตรวจและการตัดสินใจด้านการดูแลทางไกลแล้ว พร้อมส่งคำแนะนำให้รับบริการเร่งด่วนหรือพบแพทย์ที่สถานพยาบาล",
    "Not issued · referred":"ไม่ได้ออก · ส่งต่อแล้ว",
    "Referral guidance sent":"ส่งคำแนะนำการส่งต่อแล้ว",
    "Signing clinician":"แพทย์ผู้ลงนาม",
    "Audit record":"บันทึกตรวจสอบ",
    "Timestamped":"ประทับเวลาแล้ว",
    "Clinical audit log":"บันทึกตรวจสอบทางคลินิก",
    "Timestamped clinical and security events for traceability. Records are append-only in production.":"เหตุการณ์ทางคลินิกและความปลอดภัยที่ประทับเวลาเพื่อตรวจสอบย้อนหลัง ระบบจริงเพิ่มข้อมูลได้อย่างเดียว",
    "Export log":"ส่งออกบันทึก",
    "Events today":"เหตุการณ์วันนี้",
    "All recorded":"บันทึกครบแล้ว",
    "Consultations":"การปรึกษา",
    "Signed by clinician":"ลงนามโดยแพทย์",
    "Referral":"การส่งต่อ",
    "Handoff documented":"บันทึกการส่งต่อแล้ว",
    "Unresolved alerts":"การแจ้งเตือนที่ยังไม่แก้ไข",
    "No action needed":"ไม่มีรายการที่ต้องดำเนินการ",
    "Patient / consult code":"ผู้ป่วย / รหัสการปรึกษา",
    "Actor":"ผู้ดำเนินการ",
    "Period":"ช่วงเวลา",
    "Today":"วันนี้",
    "Integrity":"ความครบถ้วนของบันทึก",
    "Timestamped · append-only":"ประทับเวลา · เพิ่มข้อมูลได้อย่างเดียว",
    "Timestamp":"เวลา",
    "Event":"เหตุการณ์",
    "Patient / case":"ผู้ป่วย / เคส",
    "Result":"ผลลัพธ์",
    "Consultation completed":"ปิดการปรึกษาแล้ว",
    "Prescription signed":"ลงนามใบสั่งยาแล้ว",
    "SOAP note saved":"บันทึก SOAP แล้ว",
    "Patient joined encrypted consultation":"ผู้ป่วยเข้าห้องปรึกษาที่เข้ารหัส",
    "Identity, consent and allergy record reviewed":"ตรวจตัวตน ความยินยอม และประวัติแพ้ยาแล้ว",
    "Doctor signed in with OTP":"แพทย์เข้าสู่ระบบด้วย OTP",
    "Recorded":"บันทึกแล้ว",
    "Version retained":"เก็บประวัติเวอร์ชันแล้ว",
    "Verified":"ตรวจสอบแล้ว",
    "Confirmed":"ยืนยันแล้ว",
    "Successful":"สำเร็จ",
    "Professional identity verified · account active":"ตรวจสอบตัวตนวิชาชีพแล้ว · บัญชีใช้งานได้",
    "Registration authority":"หน่วยงานกำกับทะเบียน",
    "Medical Council of Thailand":"แพทยสภา",
    "Prescription":"ใบสั่งยา",
    "Issued":"ออกแล้ว",
    "None":"ไม่มี",
    "Waiting for the patient to pay":"รอผู้ป่วยชำระเงิน",
    "No order":"ไม่มีคำสั่งซื้อ",
    "Back to home":"กลับหน้าหลัก",
    "Open patient record":"เปิดข้อมูลผู้ป่วย",
    "Your status is back to Available, so Krane can match your next patient.":"สถานะของคุณกลับเป็นว่างแล้ว ระบบจับคู่ผู้ป่วยรายถัดไปให้ได้",
    "Send a consultation link":"ส่งลิงก์เข้ารับการปรึกษา",
    "Send the patient a link to join the consultation. Every link sent is kept in the Link tab.":"ส่งลิงก์ให้ผู้ป่วยเข้ามาปรึกษา ทุกการส่งจะถูกบันทึกไว้ในแท็บ Link",
    "Send to LINE":"ส่งไปที่ LINE",
    "Send to email":"ส่งไปที่อีเมล",
    "Send by SMS":"ส่งทาง SMS",
    "Show link":"แสดงลิงก์",
    "Copy":"คัดลอก",
    "What was discussed on the call":"รายละเอียดการติดต่อกลับ",
    "Edit patient details":"แก้ไขข้อมูลผู้ป่วย",
    "Every change is kept in the change log with your name and the time.":"ทุกการแก้ไขจะถูกบันทึกในประวัติการแก้ไขพร้อมชื่อและเวลา",
    "Your contact details, password, profile photo and signature. Licence and specialty are managed by an admin.":"ข้อมูลติดต่อ รหัสผ่าน รูปโปรไฟล์ และลายเซ็นของคุณ เลขใบอนุญาตและความเชี่ยวชาญจัดการโดยแอดมิน",
    ...
    "At least 8 characters with a number.":"อย่างน้อย 8 ตัวอักษรและมีตัวเลข",
    "Confirm new password":"ยืนยันรหัสผ่านใหม่",
    "Save new password":"บันทึกรหัสผ่านใหม่",
    "Drop a photo here or choose a file":"ลากรูปมาวางที่นี่หรือเลือกไฟล์",
    ".jpeg, .jpg or .png. It saves as soon as you add it.":"ไฟล์ .jpeg .jpg หรือ .png ระบบบันทึกทันทีที่เพิ่มรูป",
    ...
    "Patient record · consent · join":"ข้อมูลผู้ป่วย · ความยินยอม · เข้าห้อง",
    "Previous consultation record":"เวชระเบียนการปรึกษาครั้งก่อน",
    "Video call · SOAP · prescription in chat":"วิดีโอคอล · SOAP · ใบสั่งยาในแชท",
    "Finish · choose clinical outcome":"ปิดการปรึกษา · เลือกผลลัพธ์ทางคลินิก",
    "Prescription · search medicine · save":"ใบสั่งยา · ค้นหายา · บันทึก",
    "Referral / escalation alternative":"ทางเลือกการส่งต่อ / ยกระดับการดูแล",
    "Working hours":"ตั้งเวลาทำงาน",
    "Chat during the consultation":"แชทระหว่างการปรึกษา",
    "The patient sees these messages":"คนไข้เห็นข้อความนี้",
    ...
    "Repeats every week until you change it":"ใช้ซ้ำทุกสัปดาห์จนกว่าจะแก้ไข",
    "Monday":"จันทร์",
    "Tuesday":"อังคาร",
    "Wednesday":"พุธ",
    "Thursday":"พฤหัสบดี",
    ...
    "Sunday":"อาทิตย์",
    "to":"ถึง",
    "Not taking cases":"ไม่รับเคส",
    "Appointment settings":"รูปแบบการนัด",
    "Length per case":"ความยาวต่อเคส",
    "15 minutes":"15 นาที",
    "20 minutes":"20 นาที",
    "30 minutes":"30 นาที",
    "45 minutes":"45 นาที",
    "5 minutes":"5 นาที",
    "10 minutes":"10 นาที",
    "Break between cases":"เวลาพักระหว่างเคส",
    "No break":"ไม่มี",
    "Lunch break":"พักกลางวัน",
    "Exceptions":"วันที่ยกเว้น",
    "Days off or days with different hours":"วันลาหรือวันที่เวลาต่างจากปกติ",
    "27 July 2026":"27 กรกฎาคม 2569",
    "On leave all day, not taking cases":"ลาทั้งวัน ไม่รับเคส",
    "Delete":"ลบ",
    "2 August 2026":"2 สิงหาคม 2569",
    "Extra hours 18:00 to 20:00":"เปิดเพิ่ม 18:00 ถึง 20:00",
    "Add an exception":"เพิ่มวันที่ยกเว้น",
    "Waiting for the client to confirm":"รอการยืนยันจากลูกค้า",
    "Does an admin need to approve new hours before they apply?":"ต้องให้แอดมินอนุมัติก่อนเวลาใหม่มีผลหรือไม่",
    "How many weeks ahead can patients book?":"ผู้ป่วยจองล่วงหน้าได้ไกลสุดกี่สัปดาห์",
    "If hours are reduced where cases are already booked, what should happen?":"ถ้าลดเวลาแล้วมีเคสจองไว้แล้วในช่วงนั้น ระบบควรทำอย่างไร",
    "Not saved yet":"ยังไม่ได้บันทึกการแก้ไข",
    "Save working hours":"บันทึกเวลาทำงาน",
    "Type":"ประเภท",
    "Time":"เวลา",
    "Repeat":"ทำซ้ำ",
    "Does not repeat":"ไม่ทำซ้ำ",
    "Every week":"ทุกสัปดาห์",
    "Every weekday":"ทุกวันจันทร์ถึงศุกร์",
    "Off":"หยุด",
    "Good morning, Dr. Narin Tanaka":"สวัสดีตอนเช้า คุณหมอนรินทร์",
    "Meeting ID 872 4410 9930":"รหัสการประชุม 872 4410 9930",
    "Video is off. The consultation continues on voice and chat.":"วิดีโอปิดอยู่ การปรึกษายังดำเนินต่อด้วยเสียงและแชท",
    "Prototype: tap to show the patient turning their camera off":"ตัวอย่าง: แตะเพื่อจำลองว่าคนไข้ปิดวิดีโอ",
    "You have unsaved changes":"มีการแก้ไขที่ยังไม่ได้บันทึก",
    "Anan K.":"อนันต์ เค.",
    "Korn P.":"กร พี.",
    "Mina L.":"มีนา แอล.",
    "Somchai R.":"สมชาย อาร์.",
    "Win T.":"วิน ที.",
    "Ton S.":"ต้น เอส.",
    "Pim R.":"พิม อาร์.",
    "Mali S.":"มะลิ เอส."
  };
  for (var _kdc in TH_DOCTOR_CORE) TH[_kdc] = TH_DOCTOR_CORE[_kdc];
  /* ---- admin portal: demo order panel, people and the System map · 19 Sep ---- */
  var TH_ADMIN_LANG = {
    "Demo order":"ออเดอร์สำหรับสาธิต",
    "Fictional data for the client presentation":"ข้อมูลสมมติสำหรับการนำเสนอลูกค้า",
    "Patient":"ผู้ป่วย",
    "Order":"ออเดอร์",
    "Doctor":"แพทย์",
    "Condition":"อาการ",
    ...
    "Open the patient's tracking page":"เปิดหน้าติดตามพัสดุของผู้ป่วย",
    "The Base Park West, Room 22/418, Soi Sukhumvit 77, Phra Khanong Nuea, Watthana, Bangkok 10110":"เดอะ เบส พาร์ค เวสต์ ห้อง 22/418 ซอยสุขุมวิท 77 แขวงพระโขนงเหนือ เขตวัฒนา กรุงเทพฯ 10110",
    "Preparing medicine":"กำลังจัดยา",
    "Rider on the way to collect":"ไรเดอร์กำลังเข้าไปรับของ",
    "Out for delivery":"กำลังจัดส่ง",
    "Admin · Krane Ops":"แอดมิน · Krane Ops",
    "Krane Ops Admin":"แอดมิน Krane Ops",
    "Fascino Ari Operator":"เจ้าหน้าที่ Fascino สาขาอารีย์",
    "Fascino Thong Lo":"Fascino สาขาทองหล่อ",
    "Dr. Pim":"คุณหมอพิม",
    "Dr. Anong S.":"คุณหมออนงค์ เอส.",
    "MTL · Dr. Priya":"MTL · คุณหมอปรียา",
    "Jan D.":"แจน ดี.",
    "10 min":"10 นาที",
    "For example Dermatology or Ari branch":"เช่น ผิวหนัง หรือ สาขาอารีย์",
    "System map":"แผนผังระบบ",
    "How Krane maps onto the AskMacy (Fascino) base system. Reference from the CMS audit.":"Krane เชื่อมกับระบบหลัก AskMacy (Fascino) อย่างไร อ้างอิงจากการตรวจ CMS",
    "Open audit doc":"เปิดเอกสารการตรวจ",
    "Reuse":"ใช้ของเดิม",
    "AskMacy provides it":"AskMacy มีให้แล้ว",
    "Extend":"ต่อยอด",
    "Build on a base":"สร้างต่อจากของเดิม",
    "Build new":"สร้างใหม่",
    "No equivalent":"ยังไม่มีในระบบเดิม",
    "Krane capability":"ความสามารถของ Krane",
    "Verdict":"ข้อสรุป",
    "AskMacy anchor":"โมดูลที่อ้างอิงใน AskMacy",
    "Accounts / users":"บัญชี / ผู้ใช้",
    "Accounts module":"โมดูลบัญชี",
    "Reuse the RBAC and account store as is.":"ใช้ระบบสิทธิ์ (RBAC) และที่เก็บบัญชีเดิมได้เลย",
    "Doctor roles & permissions":"บทบาทและสิทธิ์ของแพทย์",
    "Accounts roles":"บทบาทในโมดูลบัญชี",
    "No Doctor role today. Add Doctor + Partner-doctor roles and fields.":"ตอนนี้ยังไม่มีบทบาทแพทย์ ต้องเพิ่มบทบาทแพทย์และแพทย์พาร์ทเนอร์พร้อมฟิลด์",
    "Auto-match & on-call routing":"จับคู่อัตโนมัติและส่งเคสให้แพทย์ที่พร้อม",
    "Agent status (partial)":"สถานะเจ้าหน้าที่ (มีบางส่วน)",
    "Agent Available/Offline exists, no matching engine.":"มีสถานะว่างและออฟไลน์ แต่ยังไม่มีระบบจับคู่",
    "Doctor schedule":"ตารางแพทย์",
    "No scheduling in AskMacy.":"AskMacy ยังไม่มีระบบตารางนัด",
    "Consultation records":"บันทึกการปรึกษา",
    "Extend the consult record + status list into a doctor queue.":"ต่อยอดบันทึกการปรึกษาและรายการสถานะให้เป็นคิวของแพทย์",
    "Intake quiz + pre-consult":"แบบสอบถามและข้อมูลก่อนปรึกษา",
    "No intake questionnaire in AskMacy.":"AskMacy ยังไม่มีแบบสอบถามก่อนปรึกษา",
    "Consultation room (video+chat)":"ห้องปรึกษา (วิดีโอและแชท)",
    "Consult + Conference Server":"โมดูลปรึกษาและเซิร์ฟเวอร์ประชุม",
    "Reuse the video/chat infra; add doctor context.":"ใช้ระบบวิดีโอและแชทเดิม เพิ่มข้อมูลสำหรับแพทย์",
    "Prescribe & e-sign":"สั่งยาและลงนามอิเล็กทรอนิกส์",
    "Product master":"ข้อมูลสินค้าหลัก",
    "Pharmacist counsels, doctor prescribing is new. Draws medicines from the product master.":"ระบบเดิมมีเภสัชกรให้คำปรึกษา ส่วนแพทย์สั่งยาเป็นของใหม่ ดึงรายการยาจากข้อมูลสินค้าหลัก",
    "Order module":"โมดูลคำสั่งซื้อ",
    "Krane cases are a filtered view over the order pipeline.":"เคสของ Krane คือมุมมองที่กรองมาจากขั้นตอนคำสั่งซื้อ",
    "Fulfilment tracking":"ติดตามการจัดส่ง",
    "Order process + Branches":"ขั้นตอนคำสั่งซื้อและสาขา",
    "Align Krane delivery steps to AskMacy Process states.":"ปรับขั้นตอนการจัดส่งของ Krane ให้ตรงกับสถานะใน AskMacy",
    "Products / Medicine catalogue":"สินค้า / รายการยา",
    "Products + Stock":"สินค้าและสต็อก",
    "Curate a Krane approved-medicine subset.":"คัดรายการยาที่ Krane อนุมัติ",
    "Branches":"สาขา",
    "Branches module":"โมดูลสาขา",
    "Reuse for fulfilment routing.":"ใช้กำหนดสาขาที่จัดส่ง",
    "Krane pricing (margin)":"ราคาของ Krane (ส่วนต่าง)",
    "Pricing module":"โมดูลราคา",
    "Add a Krane price / margin layer on the base price.":"เพิ่มชั้นราคาและส่วนต่างของ Krane บนราคาพื้นฐาน",
    "None seen":"ไม่พบในระบบเดิม",
    "Redeemable at both checkouts.":"ใช้ได้ทั้งตอนชำระค่าปรึกษาและค่ายา",
    "Content CMS (articles)":"ระบบจัดการเนื้อหา (บทความ)",
    "Two-step publish, no equivalent in AskMacy.":"เผยแพร่สองขั้นตอน ยังไม่มีใน AskMacy",
    "Partner field on orders":"ฟิลด์พาร์ทเนอร์ในคำสั่งซื้อ",
    "Add a per-channel feature-toggle layer.":"เพิ่มการเปิดปิดฟีเจอร์แยกตามช่องทาง",
    "Consultation-fee checkout":"ชำระค่าปรึกษา",
    "Order (medication only)":"คำสั่งซื้อ (เฉพาะยา)",
    "Separate consult-fee charge and flow.":"แยกการเก็บค่าปรึกษาและขั้นตอนออกมา",
    "Integration model (recommended)":"รูปแบบการเชื่อมต่อ (แนะนำ)",
    "Keep the Krane CMS as its own front-end and treat AskMacy as the backend of record for orders, products, branches and accounts, consumed through APIs. Preserve the Krane design system rather than embedding in the legacy admin theme.":"ให้ CMS ของ Krane เป็นหน้าบ้านแยก และใช้ AskMacy เป็นระบบหลักสำหรับคำสั่งซื้อ สินค้า สาขา และบัญชี ผ่าน API โดยคงดีไซน์ของ Krane ไว้ ไม่ฝังเข้าไปในธีมแอดมินเดิม",
    "System of record":"ระบบหลักของข้อมูล",
    "AskMacy (Fascino)":"AskMacy (Fascino)",
    "Krane front-end":"หน้าบ้านของ Krane",
    "Separate, this CMS":"แยกออกมา คือ CMS นี้",
    "Data boundary":"ขอบเขตข้อมูล",
    "Orders, products, branches, accounts":"คำสั่งซื้อ สินค้า สาขา บัญชี",
    "AskMacy base modules":"โมดูลหลักของ AskMacy",
    "Dashboard, Consultation, Order":"แดชบอร์ด การปรึกษา คำสั่งซื้อ",
    "live":"ใช้งานอยู่",
    "Products, Stock, Pricing":"สินค้า สต็อก ราคา",
    "Branches, Accounts (RBAC)":"สาขา บัญชี (RBAC)",
    "Settings (Conference Server), Reports":"ตั้งค่า (เซิร์ฟเวอร์ประชุม) รายงาน",
    "Audited on the dev environment. Figures are indicative dev data.":"ตรวจบนระบบทดสอบ ตัวเลขเป็นข้อมูลทดสอบโดยประมาณ"
  };
  for (var _kal in TH_ADMIN_LANG) TH[_kal] = TH_ADMIN_LANG[_kal];
  /* Patient names are written in Thai script inside Thai copy as well. */
  var TH_NAMES = {"Mali S.": "มะลิ เอส.", "Anan K.": "อนันต์ เค.", "Korn P.": "กร พี.", "Mina L.": "มีนา แอล.", "Somchai R.": "สมชาย อาร์.", "Win T.": "วิน ที.", "Ton S.": "ต้น เอส.", "Pim R.": "พิม อาร์."};
  for (var _kn in TH) { for (var _nm in TH_NAMES) { if (TH[_kn].indexOf(_nm) > -1) TH[_kn] = TH[_kn].split(_nm).join(TH_NAMES[_nm]); } }
